...
import { Alert, Container, Typography, Box, Grid, Link, TextField, CssBaseline, Button, Avatar, Snackbar } from '@mui/material'
        ...
        <>
            <Container component="main" maxWidth="xs">
                ...
                >
                    ...
                    <Box onSubmit={handleSubmit((data) => handleSubmitRegister(data))} component="form" noValidate sx={{ mt: 5 }}>
